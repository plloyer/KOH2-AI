...
namespace AIOverhaul
{
    ...
    {
        const string LogPrefix = "[AI SPEND]";
        public static void Postfix(KingdomAI __instance, KingdomAI.Expense expense, bool __result)
        {
            ...
            AIOverhaulPlugin.LogDebug($"{LogPrefix} {__instance.kingdom.Name} Executed: Type={expense.type}, Category={expense.category}, Target={expense.objectParam}, Cost={expense.cost}", LogCategory.Economy, __instance.kingdom);
        }
    }
}

...
namespace AIOverhaul
{
    ...
    public static class KingdomAI_SpendExpense
    {
        public static void Postfix(KingdomAI __instance, KingdomAI.Expense expense, bool __result)
        {
            ...
            AIOverhaulPlugin.LogDebug($"[AI SPEND] {__instance.kingdom.Name} Executed: Type={expense.type}, Category={expense.category}, Target={expense.objectParam}, Cost={expense.cost}", LogCategory.Economy, __instance.kingdom);
        }
    }
}

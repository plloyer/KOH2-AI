...
//
//             // Check for healing needs - retreat to friendly castle
//             if (army.IsHealingNeeded() && army.castle == null)
//             {
...
//                 }
//
//                 // If buddy is retreating for healing, follow them
//                 if (buddy.ai_status == AIStatusNames.RetreatHeal || buddy.ai_status == AIStatusNames.RetreatHealBuddy)
//                 {
...
//             }
//
//             if (status == AIStatusNames.Idle && army.castle == null)
//             {
...
//                     TraverseAPI.SendArmy(__instance, army, nearest, AIStatusNames.GoInside);
//                 }
//             }
//         }
//

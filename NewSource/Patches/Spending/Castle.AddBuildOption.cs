...
//                     if (!hasSwordsmith)
//                     {
//                         // Very high priority for first Swordsmith in kingdom (Higher eval = Higher priority)
...
//                     {
//                         // VERY high priority for Fletcher after Swordsmith (Higher eval = Higher priority)
...
//                                 castle = castle,
//                                 def = fletcherDef,
//                                 eval = 1000f * GameBalance.FletcherPriorityMultiplier, // Base eval * multiplier (Higher = Higher priority)
...
//                     if (option.def.id == BuildingUpgradeNames.Fletcher_Barracks)
//                     {
//                         // Block Fletcher until Swordsmith (Lower eval = Lower priority)

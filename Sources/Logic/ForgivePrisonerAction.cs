...
public class ForgivePrisonerAction : PrisonAction
{
	public ForgivePrisonerAction(Kingdom owner, Def def)
		: base(owner, def)
	{
	}
	...
	{
		return new ForgivePrisonerAction(owner as Kingdom, def);
	}

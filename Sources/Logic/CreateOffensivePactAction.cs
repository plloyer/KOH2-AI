...
public class CreateOffensivePactAction : Action
{
	public CreateOffensivePactAction(Character owner, Def def)
		: base(owner, def)
	{
	}
	...
	{
		return new CreateOffensivePactAction(owner as Character, def);
	}
	...
	public override bool ValidateTarget(Object target)
	{
		...
		if (!Pact.CanCreate(Pact.Type.Offensive, base.own_character, against))
		{
			return false;
		}
		return true;
	...
	public override void Run()
	{
		...
		if (character != null)
		{
			Pact.Create(Pact.Type.Offensive, character, base.target as Kingdom);
			base.Run();
		}
	}
}

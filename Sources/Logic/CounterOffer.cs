...
public class CounterOffer : Offer
{
	public CounterOffer(Def def, Object from, Object to)
		: base(def, from, to)
	{
	}

	public CounterOffer(Kingdom from, Kingdom to)
		: base(from, to)
	{
	}
	...
	{
		return new CounterOffer(def, from, to);
	}

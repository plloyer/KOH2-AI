...
public class KillTheKingAction : SpyPlot
{
	private Character character;

	public KillTheKingAction(Character owner, Def def)
		: base(owner, def)
	{
	}
	...
	{
		return new KillTheKingAction(owner as Character, def);
	}
	...
	public override bool ValidateTarget(Object target)
	{
		...
		if (character != base.own_character.mission_kingdom.GetKing())
		{
			return false;
		}
		if (!character.IsKing())

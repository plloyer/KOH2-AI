...
- **Direct Injection**: If Fletcher doesn't appear in upgrade options naturally, it is forcibly injected into the upgrade list with very high priority (eval: 1000 * GameBalance.FletcherPriorityMultiplier = 10)
